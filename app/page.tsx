...
export default async function LandingPage() {
  ...
  const faqs = isMalay
    ? [
        ...
        { q: 'Apakah kaedah pembayaran yang diterima?', a: 'Kami menerima bayaran melalui FPX (perbankan dalam talian — semua bank utama Malaysia), GrabPay, Touch \'n Go eWallet, dan kad kredit/debit Visa/Mastercard. Pembayaran diproses melalui DOKU, gateway pembayaran berlesen di Malaysia.' },
      ]
    : [
        ...
        { q: 'What payment methods are accepted?', a: 'We accept payment via FPX (online banking — all major Malaysian banks), GrabPay, Touch \'n Go eWallet, and Visa/Mastercard credit or debit card. Payments are processed through DOKU, a licensed payment gateway in Malaysia.' },
      ]
