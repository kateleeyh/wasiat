        ...
        {ms ? (
          <div className="space-y-8 text-slate-700 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-2">
                <li><strong>Surat Wasiat Am</strong> — Mesti ditandatangani di hadapan 2 orang saksi yang bukan penerima manfaat dan bukan pewasiat sendiri, secara serentak, seperti yang dikehendaki oleh Akta Wasiat 1959.</li>
          ...
          <div className="space-y-8 text-slate-700 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-2">
                <li><strong>General Will</strong> — Must be signed in the presence of 2 witnesses who are not beneficiaries and are not the testator, simultaneously, as required by the Wills Act 1959.</li>
